...
import com.ra.model.dto.response.PaymentLinkResponse;
...
public class PaymentController {
    ...
    public ResponseEntity<PaymentLinkResponse>creatPaymentLink(@PathVariable Long orderId , @RequestHeader("Authorization") String jwt ) throws OrderException, RazorpayException {
        ...
        try {
            ...
            paymentLinkRequest.put("callback_url","get");
